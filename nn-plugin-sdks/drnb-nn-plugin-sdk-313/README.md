...
Protocol definitions and lightweight helpers for nearest-neighbor (NN) plugins used by `drnb`. This SDK targets Python 3.13 and is intentionally small so NN plugins can stay isolated from the core `drnb` dependency graph.
